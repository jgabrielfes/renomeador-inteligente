...
export default function NotasClient({ menu }: { menu?: React.ReactNode }) {
  // --- pasta do caso ---
  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-6 px-4 py-10">
      <header className="space-y-2">
        {/* Não há mais link "← Módulos": este site É o resolvedor, e `/` já é
            esta tela. A faixa de sessão (admin/sair) vem por prop do server. */}
        {menu}
