...
export async function enviarEmailPortal({
  ...
  titulo: string;
  paragrafos: string[];
  /** Link do portal DO DESTINATÁRIO — vira o botão "Abrir meu portal". */
  urlPortal?: string;
}): Promise<boolean> {
